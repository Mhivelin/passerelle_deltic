...
class TestRoutes:
    ...
    def test_add_passerelle(self, client, db_setup):
        ...
        response = client.post(
            "/database/passerelle", json={"LibPasserelle": "test_passerelle"}
        )
        assert response.status_code == 201
    ...
    def test_add_logiciel(self, client, db_setup):
        ...
        """
        response = client.post(
            "/database/logiciel", json={"lib_logiciel": "test_logiciel"}
        )
        assert response.status_code == 201
    ...
    def test_add_champ(self, client, db_setup):
        ...
        response = client.post(
            "/database/champ",
            json={"lib_champ": "test_champ", "nom_table": "test_table"},
        )
        assert response.status_code == 201
    ...
    def test_add_passerelle_with_connectors_and_fields(self, client, db_setup):
        ...
        response = client.post(
            "/database/add_passerelle_with_champs",
            data={
